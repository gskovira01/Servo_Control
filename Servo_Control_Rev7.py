...
def process_response(message, expected):
    ...
    global values_received, states_received, setpoints_received, servo_states
...
layout = [
    ...
    [sg.Text('Servo 1', size=(8, 1)), 
     ...
     sg.InputText(S1V_SPT, key='S1V_SPT', size=(8, 1), justification='right'),
     sg.InputText(S1A_SPT, key='S1A_SPT', size=(8, 1), justification='right'),
     sg.InputText(S1P_SPT, key='S1P_SPT', size=(8, 1), justification='right'),
     sg.Button('OK', key='S1B3')],
    [sg.Text(' ', size=(8, 1)), sg.Text('Current Value', size=(14, 1)),  # Adjusted size
     sg.Text(' ', size=(2, 1)), sg.Text(arduino_values['S1V'], size=(8, 1), key='S1V_display'),
     sg.Text(arduino_values['S1A'], size=(8, 1), key='S1A_display'),
     sg.Text(arduino_values['S1P'], size=(8, 1), key='S1P_display')],
    ...
    [sg.Text('Servo 2', size=(8, 1)), 
     ...
     sg.InputText(S2V_SPT, key='S2V_SPT', size=(8, 1), justification='right'),
     sg.InputText(S2A_SPT, key='S2A_SPT', size=(8, 1), justification='right'),
     sg.InputText(S2P_SPT, key='S2P_SPT', size=(8, 1), justification='right'),
     sg.Button('OK', key='S2B3')],
    [sg.Text(' ', size=(8, 1)), sg.Text('Current Value', size=(14, 1)),  # Adjusted size
     sg.Text(' ', size=(2, 1)), sg.Text(arduino_values['S2V'], size=(8, 1), key='S2V_display'),
     sg.Text(arduino_values['S2A'], size=(8, 1), key='S2A_display'),
     sg.Text(arduino_values['S2P'], size=(8, 1), key='S2P_display')],
    ...
    [sg.Text('Servo 3', size=(8, 1)), 
     ...
     sg.InputText(S3V_SPT, key='S3V_SPT', size=(8, 1), justification='right'),
     sg.InputText(S3A_SPT, key='S3A_SPT', size=(8, 1), justification='right'),
     sg.InputText(S3P_SPT, key='S3P_SPT', size=(8, 1), justification='right'),
     sg.Button('OK', key='S3B3')],
    [sg.Text(' ', size=(8, 1)), sg.Text('Current Value', size=(14, 1)),  # Adjusted size
     sg.Text(' ', size=(2, 1)), sg.Text(arduino_values['S3V'], size=(8, 1), key='S3V_display'),
     sg.Text(arduino_values['S3A'], size=(8, 1), key='S3A_display'),
     sg.Text(arduino_values['S3P'], size=(8, 1), key='S3P_display')],
    ...
    [sg.Text('Servo 4', size=(8, 1)), 
     ...
     sg.InputText(S4V_SPT, key='S4V_SPT', size=(8, 1), justification='right'),
     sg.InputText(S4A_SPT, key='S4A_SPT', size=(8, 1), justification='right'),
     sg.InputText(S4P_SPT, key='S4P_SPT', size=(8, 1), justification='right'),
     sg.Button('OK', key='S4B3')],
    [sg.Text(' ', size=(8, 1)), sg.Text('Current Value', size=(14, 1)),  # Adjusted size
     sg.Text(' ', size=(2, 1)), sg.Text(arduino_values['S4V'], size=(8, 1), key='S4V_display'),
     sg.Text(arduino_values['S4A'], size=(8, 1), key='S4A_display'),
     sg.Text(arduino_values['S4P'], size=(8, 1), key='S4P_display')],
]

window = sg.Window("Servo Control", 
            layout, default_element_size=(6, 5), 
            size=(700, 500), 
