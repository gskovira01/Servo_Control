            ...
            if event not in last_event_time or (current_time - last_event_time[event] > DEBOUNCE_INTERVAL):
                ...
                match event:
                    case 'Mode':
                        ...
                        window[event].update(text='Manual' if GUI_button_states[event] else 'Auto', button_color=('white', 'red') if GUI_button_states[event] else ('white', 'green'))
                        window.refresh()
