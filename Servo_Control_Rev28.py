...
def show_numeric_keypad(title, current_value, min_val=0, max_val=18000):
    ...
    popup_window = sg.Window(title, layout, modal=True, finalize=True, location=(0, 0))
...
# Show loading screen
loading_layout = [
    [sg.Text('Servo Control System', font=('Helvetica', 20, 'bold'), justification='center')],
    [sg.Text(' ', size=(20, 1))],
    [sg.Text('Initializing...', font=('Helvetica', 14), justification='center')],
    [sg.Text('Please wait while connecting to controllers', font=('Helvetica', 10), justification='center')],
    [sg.Text(' ', size=(20, 1))]
]
loading_window = sg.Window('Loading', loading_layout, no_titlebar=True, 
                          keep_on_top=True, location=(200, 150), 
                          alpha_channel=0.9, finalize=True)
